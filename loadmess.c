...
static void loadmess_float(t_loadmess *x, t_floatarg f)
{
  x->x_ac = 1;
  SETFLOAT(x->x_at, f);
  x->x_sym = &s_float;
...
static void loadmess_symbol(t_loadmess *x, t_symbol *s)
{
  x->x_ac = 1;
  SETSYMBOL(x->x_at, s);
  x->x_sym = &s_symbol;
...
static void loadmess_pointer(t_loadmess *x, t_gpointer *gp)
{
  x->x_ac = 1;
...
static void loadmess_list(t_loadmess *x, t_symbol *s, int ac, t_atom *av)
{
  t_atom *at;
...
static void loadmess_anything(t_loadmess *x, t_symbol *s, int ac, t_atom *av)
{
  t_atom *at;
...
void loadmess_setup(void)
{
  ...
  class_addcreator((t_newmethod)loadmess_new, gensym("ii"), A_GIMME, 0);
  ...
  class_addanything(loadmess_class, loadmess_anything);
  class_addlist(loadmess_class, loadmess_list);
  class_addpointer(loadmess_class, loadmess_pointer);
  class_addfloat(loadmess_class, (t_method)loadmess_float);
  class_addsymbol(loadmess_class, loadmess_symbol);
}
